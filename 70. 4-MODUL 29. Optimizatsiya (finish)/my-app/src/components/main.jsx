...
const Main = () => {
    ...
    ////loyihadagi cardlar html va stylelari main jsxda edi shuni alohida componentga olib main jsxda faqat componentni o'zini intratsa yani tsikilga qo'yildi shunda yanaham tartibli bo'ladi yani hamma narsa o'z joyida va mainga componentlar chaqirilib ishlatildi bu real loyihalarda shunday tartibda ishlanadi va endi bu articlecard.jsxni boshqa joyga chaqiribham qaytadan ishlatish mumkun shunda ish ancha kamayar ekan
                    ...
                    <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                        {articles.map(article => {
                            return (
                                ...
                                <ArticleCard key={article.slug} article={article} getArticles={getArticles}/>
                            );
                        })}
                    </div>
                </div>
