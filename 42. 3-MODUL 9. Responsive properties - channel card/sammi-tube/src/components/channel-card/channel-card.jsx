        ...
        >
            ...
            >
                ...
                <Typography variant="h6">
                    {video?.snippet?.title}
                    {/* yani yuqoridagi kodda rasim chiqsaham chiqmasaham rasimni titeli chiqsin shu Typography ichida  */}

                    <CheckCircle
                        sx={{ fontSize: "14px", color: "gray", ml: "5px" }}
                    />
                    {/* bu checkcircle channelni nomidan yani titelidan keyin chiqadi yani>> ✓ shu symbol CheckCircleda uidan keladi va stylelar berildi  */}
                </Typography>
