...
export const countSlice = createSlice({
    //bu holatda createSliceni import uchun nomi countSlice//
    //createSliceno useeffect va usestatelardan farqi bu o'zgarmas funksiya va doim reducers papkada export qilinadi  shu sabab export (yani default holatda bu doim exportda) qilib yoziladi
...
//export qilish
export const {plusCounter,minusCounter,resetCounter} = countSlice.actions//actions countSlice nomli createSlice funksiyasini qiymatlari hissoblanadi bu holatda bu qiymatlar plusCounter,minusCounter,resetCounter funksiyalariga teng